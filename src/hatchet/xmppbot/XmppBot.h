...
public slots:
    virtual void newTrackSlot(const Hatchet::result_ptr track);
    virtual void infoReturnedSlot(QString caller, Hatchet::InfoSystem::InfoType type, QVariant input, QVariant output, QVariantMap customData);
...
private slots:
    void onResultsAdded( const QList<Hatchet::result_ptr>& result );

private:
    QPointer<XMPPBotClient> m_client;
    Hatchet::result_ptr m_currTrack;
    Hatchet::InfoSystem::InfoTypeMap m_currInfoMap;
