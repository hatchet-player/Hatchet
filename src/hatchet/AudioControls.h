...
class AudioControls : public BackgroundWidget, private HatchetUtils::DpiScaler
{
Q_OBJECT
...
public slots:
    void onRepeatModeChanged( Hatchet::PlaylistModes::RepeatMode mode );
...
private slots:
    ...
    void droppedTracks( QList<Hatchet::query_ptr> );

    void onCoverUpdated();
    void onSocialActionsLoaded();

    void onInfoSystemPushTypesUpdated( Hatchet::InfoSystem::InfoTypeSet supportedTypes );
...
private:
    ...
    Hatchet::PlaylistModes::RepeatMode m_repeatMode;
    bool m_shuffled;
