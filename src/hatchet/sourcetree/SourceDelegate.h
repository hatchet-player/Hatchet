...
signals:
    ...
    void latchOn( const Hatchet::source_ptr& idx );
    void latchOff( const Hatchet::source_ptr& idx );
    void toggleRealtimeLatch( const Hatchet::source_ptr& idx, bool realtime );
