    ...
    , m_loading( true )
{
    ...
    ui->breadCrumbLeft->setRootIcon( HatchetUtils::defaultPixmap( HatchetUtils::NewReleases, HatchetUtils::Original ) );
...
NewReleasesWidget::fetchData()
{
    ...
    requestData.type = Hatchet::InfoSystem::InfoNewReleaseCapabilities;
...
void
NewReleasesWidget::infoSystemInfo( Hatchet::InfoSystem::InfoRequestData requestData, QVariant output )
{
    ...
    switch ( requestData.type )
    {
        ...
        case InfoSystem::InfoNewRelease:
        {
            ...
            const QString releaseId = requestData.input.value< Hatchet::InfoSystem::InfoStringHash >().value( "nr_id" );
            ...
            if ( type == "albums" )
            {
                ...
                connect( loader, SIGNAL( albums( Hatchet::ChartDataLoader*, QList< Hatchet::album_ptr > ) ), this, SLOT( newReleasesLoaded( Hatchet::ChartDataLoader*, QList<Hatchet::album_ptr> ) ) );
...
NewReleasesWidget::leftCrumbIndexChanged( QModelIndex index )
{
    ...
    requestData.type = Hatchet::InfoSystem::InfoNewRelease;
    requestData.timeoutMillis = 20000;
    requestData.allSources = true;
