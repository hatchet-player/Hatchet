...
#pragma once
#ifndef HATCHETUTILS_H
#define HATCHETUTILS_H
...
namespace HatchetUtils
{
     ...
     */
    DLLEXPORT QList< Hatchet::query_ptr > mergePlaylistChanges( const QList< Hatchet::query_ptr >& orig, const QList< Hatchet::query_ptr >& newTracks, bool& changed );
