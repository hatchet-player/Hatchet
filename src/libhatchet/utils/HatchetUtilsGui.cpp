...
createDragPixmap( MediaType type, int itemCount )
{
    ...
    switch ( type )
    {
        case MediaTypeArtist:
            pixmap = HatchetUtils::defaultPixmap( HatchetUtils::DefaultArtistImage, HatchetUtils::Original, QSize( size, size ) );
            break;
        case MediaTypeAlbum:
            pixmap = HatchetUtils::defaultPixmap( HatchetUtils::DefaultAlbumCover, HatchetUtils::Original, QSize( size, size ) );
            break;
        case MediaTypeTrack:
            pixmap = HatchetUtils::defaultPixmap( HatchetUtils::DefaultTrackImage, HatchetUtils::Original, QSize( size, size ) );
            break;
    }
...
drawQueryBackground( QPainter* p, const QRect& r )
{
    ...
    p->setPen( HatchetStyle::SELECTION_BACKGROUND );
    p->setBrush( HatchetStyle::SELECTION_BACKGROUND );
...
hatchetWindow()
{
    ...
    {
        qDebug() << Q_FUNC_INFO << "could not find main Hatchet mainwindow";
        Q_ASSERT( false );
        return 0;
    }
    ...
    switch ( type )
    {
        ...
        case DefaultTrackImage:
            if ( mode == RoundedCorners )
                pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/track-placeholder-grid.svg", size, HatchetUtils::RoundedCorners );
            else
        ...
        case DefaultSourceAvatar:
            if ( mode == RoundedCorners )
                pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/user-avatar.svg", size, HatchetUtils::RoundedCorners );
            else
        ...
        case DefaultResolver:
            if ( mode == RoundedCorners )
                pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/resolver-default.svg", size, HatchetUtils::RoundedCorners );
            else
        ...
        case PlayButton:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/play.svg", size, HatchetUtils::Original, 0.8, Qt::white );
            break;
        case PlayButtonPressed:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/play.svg", size, HatchetUtils::Original, 1.0, Qt::white );
            break;

        case PauseButton:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/pause.svg", size, HatchetUtils::Original, 0.8, Qt::white );
            break;
        case PauseButtonPressed:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/pause.svg", size, HatchetUtils::Original, 1.0, Qt::white );
            break;

        case PrevButton:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/back.svg", size, HatchetUtils::Original, 0.8, Qt::white );
            break;
        case PrevButtonPressed:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/back.svg", size, HatchetUtils::Original, 1.0, Qt::white );
            break;

        case NextButton:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/forward.svg", size, HatchetUtils::Original, 0.8, Qt::white );
            break;
        case NextButtonPressed:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/forward.svg", size, HatchetUtils::Original, 1.0, Qt::white );
            break;

        case ShuffleOff:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/shuffle.svg", size, HatchetUtils::Original, 0.7, Qt::white );
            break;
        case ShuffleOffPressed:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/shuffle.svg", size, HatchetUtils::Original, 1.0, Qt::white );
            break;
        case ShuffleOn:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/shuffle.svg", size, HatchetUtils::Original, 1.0, Qt::white );
            break;
        ...
        case RepeatOne:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/repeat-one.svg", size, HatchetUtils::Original, 1.0, Qt::white );
            break;
        case RepeatOnePressed:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/repeat-one.svg", size, HatchetUtils::Original, 1.0, Qt::white );
            break;
        case RepeatAll:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/repeat-all.svg", size, HatchetUtils::Original, 1.0, Qt::white );
            break;
        case RepeatAllPressed:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/repeat-all.svg", size, HatchetUtils::Original, 1.0, Qt::white );
            break;
        case RepeatOff:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/repeat.svg", size, HatchetUtils::Original, 0.7, Qt::white );
            break;
        case RepeatOffPressed:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/repeat.svg", size, HatchetUtils::Original, 1.0, Qt::white );
            break;

        case Volume:
            pixmap = ImageRegistry::instance()->pixmap( RESPATH "images/volume-icon.svg", size, HatchetUtils::Original, 0.7, Qt::white );
            break;
...
prepareStyleOption( QStyleOptionViewItem* option, const QModelIndex& index, PlayableItem* item )
{
    ...
    if ( item->isPlaying() )
    {
        option->backgroundBrush = HatchetStyle::NOW_PLAYING_ITEM;
        option->palette.setColor( QPalette::Highlight, HatchetStyle::NOW_PLAYING_ITEM.lighter() );
        option->palette.setColor( QPalette::Text, HatchetStyle::NOW_PLAYING_ITEM_TEXT );
        option->palette.setColor( QPalette::Foreground, HatchetStyle::NOW_PLAYING_ITEM_TEXT );
    }
