...
void
HatchetStyle::horizontalHeader( QPainter* painter, const QRect& r )
{
    painter->save();

    /*    QRect upperHalf( 0, 0, r.width(), r.height() / 2 );
     QRect lowerHalf( 0, upperHalf.height(), r.width(), r.height() );
     painter->fillRect( upperHalf, HatchetStyle::headerUpperColor() );
     painter->fillRect( lowerHalf, HatchetStyle::headerLowerColor() );*/
    QLinearGradient gradient( QPoint( 0, 0 ), QPoint( 0, 1 ) );
    gradient.setCoordinateMode( QGradient::ObjectBoundingMode );
    gradient.setColorAt( 0.0, HatchetStyle::HEADER_BACKGROUND );
    gradient.setColorAt( 1.0, HatchetStyle::HEADER_BACKGROUND );
 ...
 */
void
HatchetStyle::drawArrow( QStyle::PrimitiveElement element, QPainter* p, const QStyleOption* opt )
{
...
void
HatchetStyle::stylePageFrame( QFrame* frame )
{
...
void
HatchetStyle::stylePageWidget( QWidget* widget )
{
...
void
HatchetStyle::styleScrollBar( QScrollBar* scrollBar )
{
