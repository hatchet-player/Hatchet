...
#ifndef HATCHETCACHE_H
#define HATCHETCACHE_H
...
inline QDataStream& operator<< ( QDataStream& in, const HatchetUtils::CacheData& data )
{
   in << data.data << data.maxAge;
   return in;
}

inline QDataStream& operator>> ( QDataStream& out, HatchetUtils::CacheData& data )
{
    out >> data.data;
    out >> data.maxAge;
    return out;
...
Q_DECLARE_METATYPE( HatchetUtils::CacheData );

#endif // HATCHETCACHE_H
