...
DelegateConfigWrapper::DelegateConfigWrapper( Hatchet::Accounts::Account* account, QWidget* parent, Qt::WindowFlags flags )
...
DelegateConfigWrapper::onConfigTestResult( int code, const QString& message )
{
    ...
    if( code == Hatchet::Accounts::ConfigTestResultSuccess )
    {
...
{
    switch(code) {
	case Hatchet::Accounts::ConfigTestResultCommunicationError:
	    return tr( "Unable to authenticate. Please check your connection." );
	case Hatchet::Accounts::ConfigTestResultInvalidCredentials:
	    return tr( "Username or password incorrect." );
	case Hatchet::Accounts::ConfigTestResultInvalidAccount:
	    return tr( "Account rejected by server." );
	case Hatchet::Accounts::ConfigTestResultPlayingElsewhere:
	    return tr( "Action not allowed, account is in use elsewhere." );
	case Hatchet::Accounts::ConfigTestResultAccountExpired:
