    ...
    , m_accountId( accountId )
{
    ...
    connect( this, SIGNAL( connectionStateChanged( Hatchet::Accounts::Account::ConnectionState ) ) , this, SLOT( onConnectionStateChanged( Hatchet::Accounts::Account::ConnectionState ) ) );
