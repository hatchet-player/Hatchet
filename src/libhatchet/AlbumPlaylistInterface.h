...
#ifndef HATCHETALBUMPLAYLISTINTERFACE_H
#define HATCHETALBUMPLAYLISTINTERFACE_H
...
class DLLEXPORT AlbumPlaylistInterface : public Hatchet::PlaylistInterface
{
Q_OBJECT

public:
    AlbumPlaylistInterface( Hatchet::Album* album, Hatchet::ModelMode mode, const Hatchet::collection_ptr& collection );
...
private:
    ...
    QPointer< Hatchet::Album > m_album;
