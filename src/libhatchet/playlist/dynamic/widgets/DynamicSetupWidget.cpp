...
DynamicSetupWidget::DynamicSetupWidget( const Hatchet::dynplaylist_ptr& playlist, QWidget* parent )
    : QWidget( parent )
    , m_playlist( playlist )
    , m_headerText( 0 )
...
void
DynamicSetupWidget::setPlaylist( const Hatchet::dynplaylist_ptr& playlist )
{
    Q_UNUSED( playlist );
}
