 ...
 *
 * This Hatchet ViewPage displays the tracks of any given album
...
class DLLEXPORT AlbumInfoWidget : public QWidget, public Hatchet::ViewPage
{
Q_OBJECT

public:
    AlbumInfoWidget( const Hatchet::album_ptr& album, QWidget* parent = 0 );
    ~AlbumInfoWidget();

    Hatchet::album_ptr album() const { return m_album; }
...
public slots:
     ...
     */
    void load( const Hatchet::album_ptr& album );
