...
{
    connect( this, SIGNAL( trackPlaying( Hatchet::track_ptr, unsigned int ) ),
             source().data(), SLOT( onPlaybackStarted( Hatchet::track_ptr, unsigned int ) ), Qt::QueuedConnection );
    connect( this, SIGNAL( trackPlayed( Hatchet::track_ptr, Hatchet::PlaybackLog ) ),
             source().data(), SLOT( onPlaybackFinished( Hatchet::track_ptr, Hatchet::PlaybackLog ) ), Qt::QueuedConnection );
