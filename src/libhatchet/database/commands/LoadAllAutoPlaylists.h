...
public:
    explicit DatabaseCommand_LoadAllAutoPlaylists( const Hatchet::source_ptr& s, QObject* parent = 0 )
...
signals:
    void autoPlaylistLoaded( const Hatchet::source_ptr& source, const QVariantList& data );
    void done();
