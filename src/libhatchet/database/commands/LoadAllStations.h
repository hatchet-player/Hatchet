...
public:
    explicit DatabaseCommand_LoadAllStations( const Hatchet::source_ptr& s, QObject* parent = 0 )
...
signals:
    void stationLoaded( const Hatchet::source_ptr& source, const QVariantList& data );
    void done();
