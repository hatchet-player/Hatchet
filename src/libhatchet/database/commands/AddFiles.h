...
public:
    ...
    explicit DatabaseCommand_AddFiles( const QList<QVariant>& files, const Hatchet::source_ptr& source, QObject* parent = 0 )
...
signals:
    void done( const QList<QVariant>&, const Hatchet::collection_ptr& );
