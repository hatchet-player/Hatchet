...
class ACCOUNTDLLEXPORT HatchetXmppMessageFactory : public Jreen::PayloadFactory<HatchetXmppMessage>
{
public:
    HatchetXmppMessageFactory();
    virtual ~HatchetXmppMessageFactory();
